...
function Footer() {
  return (
    <footer className="sh-footer">
      <div className="sh-f-inner">
        <div className="sh-f-grid">
          <div>
            <div className="sh-f-logo">
            ...
            <p className="sh-f-desc">
              To empower local fashion brands and make shopping local simple,
              trusted, and accessible.
            </p>
            <div className="sh-f-soc">
              {["facebook-f", "instagram", "twitter", "youtube"].map((i) => (
                <a key={i} href="#">
          ...
          <div>
            <h6 className="sh-f-head">Shop</h6>
            <ul className="sh-f-list">
              {[
                "Women's Fashion",
                "Men's Fashion",
                "Kids' Fashion",
          ...
          <div>
            <h6 className="sh-f-head">Company</h6>
            <ul className="sh-f-list">
              {[
                "About Us",
                "Term & Policy",
          ...
          <div>
            <h6 className="sh-f-head">Help</h6>
            <ul className="sh-f-list">
              {[
                "Help Center",
                "Feedback",
          ...
          <div>
            <h6 className="sh-f-head">Contact</h6>
            <ul className="sh-f-contact">
              <li>
        ...
        <div className="sh-f-bar">© 2025 StyleHub — All rights reserved.</div>
      </div>
    </footer>
  );
}
