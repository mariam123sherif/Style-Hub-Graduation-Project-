...
const BRAND = {
  name:        "Antika",
  desc:        "Antika is a clothing brand that blends classic, Old Money aesthetics with modern streetwear. The brand focuses on creating stylish everyday pieces such as hoodies, baggy jeans, polos and sweaters — combining comfort with a refined yet edgy look for people who appreciate timeless style with a modern urban twist.",
  logo:        "./public/images/antika_logo.webp",
  heroBg:      "./public/images/salty-hero.jpg",
  accentColor: "#92A079",
