...
const BASE = 'https://phonebook-limit-unnatural.ngrok-free.dev';
...
function SignInForm({ onForgot, onSwitchSignUp }) {
  ...
  const submit = async (e) => {
    ...
    setBusy(true);
    try {
      const res = await fetch(`${BASE}/api/customer/auth/signin`, {
        method: "POST",
...
function SignUpForm({ onSwitchSignIn }) {
  ...
  const submit = async (e) => {
    ...
    setBusy(true);
    try {
      const res = await fetch(`${BASE}/api/customer/auth/signup`, {
        method: "POST",
        headers: { "Content-Type": "application/json", "ngrok-skip-browser-warning": "true" },
...
function ForgotEmail({ onNext }) {
  ...
  const submit = async (e) => {
    ...
    setBusy(true);
    try {
      const res = await fetch(`${BASE}/api/customer/auth/forgot-password`, {
        method: "POST",
        headers: { "Content-Type": "application/json", "ngrok-skip-browser-warning": "true" },
...
function ForgotNewPw({ onDone }) {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${BASE}/api/customer/auth/reset-password`, {
        method: "POST",
        headers: { "Content-Type": "application/json", "ngrok-skip-browser-warning": "true" },
