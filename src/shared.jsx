...
export const PRODUCTS = [
  ...
  { id:4,  tab:"best",  gender:"women", name:"27 Pink Sweater",          brand:"27",           price:"LE 750",   oldPrice:"LE 950",   img:"/pink27.jpg",   imgs:["/b2.jpg","/chart.jpg"],      colors:["#f4a0b5"],              sizes:["XS","S","M","L","XL"],  rating:4.6, reviews:203, desc:"100% cotton, Boxy fit, dreamy blush pink." },
  ...
  { id:22, tab:"sale",  gender:"unisex", name:"Basic Sweatpants",         brand:"27",           price:"LE 690",   oldPrice:"LE 900",   img:"/pant.jpg",                                         colors:["#b2aa9cff"],            sizes:["XS","S","M","L","XL"], rating:4.6, reviews:54,  desc:"Beige Basic Sweatpants." },
  ...
  { id:9,  tab:"trend", gender:"women", name:"Yellow 27 Sweater",        brand:"27",           price:"LE 600",   oldPrice:"LE 890",   img:"/027.jpg",                                          colors:["#d0c259ff"],            sizes:["S","M","L","XL"],       rating:4.6, reviews:38,  desc:"Yellow 27 sweater." },
...
// ─── NAV ───
export function SHNav({ cart=0, wish=[] }) {
  return (
  ...
  <a href="/SignIn" className="nav-icon">{I.user}</a>
